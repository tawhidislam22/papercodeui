            ...
            {lesson.reviewsCount ? (
              <div className="flex items-center gap-1 mt-1">
                <div className="flex items-center text-amber-400">
                  ...
                  <span className="text-sm font-semibold text-gray-700 ml-1">{lesson.averageRating?.toFixed(1) || '0.0'}</span>
                </div>
                <span className="text-xs text-gray-400">({lesson.reviewsCount})</span>
              </div>
            ) : null}
